...
public class MetaTileEntityLoader {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        registerMachineRecipe(provider, GTMachines.ELECTRIC_BLAST_FURNACE, "EDE", "CMC", "WQW", 'M', HULL, 'E', CIRCUIT, 'W',
                CABLE, 'C', COIL_HEATING, 'Q', COIL_HEATING_DOUBLE, 'D', PLATE_DOUBLE);
        registerMachineRecipe(provider, GTMachines.ELECTRIC_SMOKING_FURNACE, "ESE", "CMC", "WQW", 'M', HULL, 'E', CIRCUIT, 'W',
