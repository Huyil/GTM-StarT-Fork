...
public class GTRecipeEMICategory extends EmiRecipeCategory {
    ...
    public static EmiRecipeCategory machineCategory(GTRecipeCategory category) {
        ...
        else if (category == GTRecipeTypes.BLAST_FURNACE_RECIPES.getCategory()) return VanillaEmiRecipeCategories.BLASTING;
        else if (category == GTRecipeTypes.SMOKING_FURNACE_RECIPES.getCategory()) return VanillaEmiRecipeCategories.SMOKING;
