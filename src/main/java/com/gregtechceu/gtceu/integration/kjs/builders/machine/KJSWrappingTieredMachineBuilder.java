...
public class KJSWrappingTieredMachineBuilder extends BuilderBase<MachineDefinition> {

    @HideFromJS
    @Getter
    private final KJSTieredMachineBuilder tieredBuilder;

    public KJSWrappingTieredMachineBuilder(ResourceLocation id, KJSTieredMachineBuilder tieredBuilder) {
        super(id);
    ...
    public KJSWrappingTieredMachineBuilder machine(KJSTieredMachineBuilder.TieredCreationFunction machine) {
        tieredBuilder.machine(machine);
        return this;
    }

    public KJSWrappingTieredMachineBuilder definition(KJSTieredMachineBuilder.DefinitionFunction definition) {
        tieredBuilder.definition(definition);
        return this;
    }

    public KJSWrappingTieredMachineBuilder tankScalingFunction(Int2IntFunction tankScalingFunction) {
        tieredBuilder.tankScalingFunction(tankScalingFunction);
        return this;
    }

    public KJSWrappingTieredMachineBuilder addDefaultTooltips(boolean addDefaultTooltips) {
        tieredBuilder.addDefaultTooltips(addDefaultTooltips);
        return this;
    }

    public KJSWrappingTieredMachineBuilder addDefaultModel(boolean addDefaultModel) {
        tieredBuilder.addDefaultModel(addDefaultModel);
        return this;
    }

    public KJSWrappingTieredMachineBuilder isGenerator(boolean isGenerator) {
